# Nexo Propiedades — Sistema inmobiliario

Un CRM completo para inmobiliarias, con propiedades, leads, pipeline de ventas, conversaciones y llamadas con resumen por IA. Un sistema demo hecho con Next.js.
...
## Qué incluye
- Dashboard con metricas del negocio
- Propiedades (catalogo con filtros por operacion)
- Conversaciones (inbox de leads)
- Pipeline de ventas (kanban por etapas)
- Llamadas con resumen por IA
- Contactos (leads)
- Configuracion
...
2. Cloná el repo:
       ...
       git clone https://github.com/jlucasacosta/sistema-inmobiliaria.git
