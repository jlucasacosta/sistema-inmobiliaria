...
const radiusMap = { sharp: "3px", soft: "10px", round: "16px" }
const densityMap = { compact: "12px", comfortable: "20px" }
const badgeMap = { pill: "9999px", square: "3px" }
...
export default function RootLayout({ children }: { children: ReactNode }) {
  ...
  const vars = {
    ...
    "--font-heading": "var(--font-heading-src), Georgia, serif",
    "--font-body": "var(--font-body-src), system-ui, sans-serif",
    "--font-number": "var(--font-heading-src), Georgia, serif",
    ...elevationVars(),
  } as CSSProperties
